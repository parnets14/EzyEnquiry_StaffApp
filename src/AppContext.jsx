...
export const AppProvider = ({ children }) => {
  ...
  const verifyLoginOtp = async otp => {
    ...
    const merged = staffRecord ? {
      ...
      roleAccess:   staffRecord.roleAccess   || staffRecord.designation || staffRecord.role || '',
      salary:       staffRecord.salary       || 0,
      incentiveSlabs: Array.isArray(staffRecord.incentiveSlabs) ? staffRecord.incentiveSlabs : [],
      monthSales:      staffRecord.monthSales      || 0,
      incentivePct:    staffRecord.incentivePct    || 0,
      incentiveAmount: staffRecord.incentiveAmount || 0,
      incentivePeriod: staffRecord.incentivePeriod || '',
